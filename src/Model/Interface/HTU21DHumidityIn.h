...
#ifndef SRC_MODEL_INTERFACE_HTU21DHUMIDITYIN_H_
#define SRC_MODEL_INTERFACE_HTU21DHUMIDITYIN_H_
...
class HTU21DHumidityIn: public Sensor {
public:
    HTU21DHumidityIn(::AuraNode::Module::HTU21DModule* module);
    virtual ~HTU21DHumidityIn();
...
#endif /* SRC_MODEL_INTERFACE_HTU21DHUMIDITYIN_H_ */
