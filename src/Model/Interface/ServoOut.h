...
#ifndef AURANODE_INTERFACE_SERVOOUT_H
#define AURANODE_INTERFACE_SERVOOUT_H
...
class ServoOut: public Actuator {
public:

	ServoOut(::AuraNode::IO::PWMOutput* /*in*/pin);
	void write(OSCMessage& /*in*/msg);
