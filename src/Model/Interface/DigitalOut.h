...
#ifndef AURANODE_INTERFACE_DIGITALOUT_H
#define AURANODE_INTERFACE_DIGITALOUT_H
...
class DigitalOut: public Actuator {
public:

	DigitalOut(::AuraNode::IO::DigitalOut* io);
	void write(OSCMessage& msg);

private:

	::AuraNode::IO::DigitalOut* mPin;
};
