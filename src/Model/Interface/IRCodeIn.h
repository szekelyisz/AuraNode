...
#ifndef SRC_MODEL_INTERFACE_IRCODEIN_H_
#define SRC_MODEL_INTERFACE_IRCODEIN_H_
...
class IRCodeIn : public Sensor {
public:

	IRCodeIn(::AuraNode::IO::IRCodeIn *io);
	virtual ~IRCodeIn();
