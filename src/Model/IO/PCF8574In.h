...
#ifndef AURANODE_IO_I2CDIGITALIN_H
#define AURANODE_IO_I2CDIGITALIN_H
...
class PCF8574In: public DigitalIn {
public:

	PCF8574In(::AuraNode::Module::PCF8574Module* module, uint8_t pin);
	bool readValue();
