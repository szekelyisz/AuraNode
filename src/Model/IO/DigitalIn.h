...
#ifndef AURANODE_IO_DIGITALIN_H
#define AURANODE_IO_DIGITALIN_H

#include <Model/Interface/DigitalIn.h>
#include <Model/IO/Input.h>
...
protected:
	::AuraNode::Interface::DigitalIn* mInterface;

public:

	void subscribe(::AuraNode::Interface::DigitalIn* interface);
