...
bool loadConfig() {
	...
	filenames.push_back(String(Skeleton.getHostname()) + fn_postfix);
	filenames.push_back(fn_prefix + Skeleton.getHostname() + fn_postfix);
